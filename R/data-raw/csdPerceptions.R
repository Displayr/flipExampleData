csdPerceptions <- matrix(c(0.3004, 0.6864, 0.4975, 0.2908, 0.2781, 0.2642, 0.1916, 0.284,  0.3514, 0.2534, 0.2089,
  ...
  dimnames=list(Brand=c('Coke','V',"Red\nBull","Lift\nPlus",'Diet\nCoke','Fanta','Lift','Pepsi'),
  Attribute=c('Kids', 'Teens',    "Enjoy life",   'Picks\nyou up', 'Refreshes',    'Cheers\nyou up',    'Energy',   'Up-to-date',  'Fun',  'When tired',   'Relax')))
devtools::use_data(csdPerceptions, internal = FALSE, overwrite = TRUE)
